...
part 'src/com/hydrologis/dart_jts/operation/union.dart';
part 'src/com/hydrologis/dart_jts/operation/overlay.dart';
part 'src/com/hydrologis/dart_jts/operation/overlay_snap.dart';
...
part 'src/com/hydrologis/dart_jts/geomgraph/edge_noding_validator.dart';
...
part 'src/com/hydrologis/dart_jts/util/geometry_transformer.dart';
part 'src/com/hydrologis/dart_jts/extra.dart';
part 'src/com/hydrologis/dart_jts/geom/affinetransformation.dart';
part 'src/com/hydrologis/dart_jts/precision/common_bits_remover.dart';
part 'src/com/hydrologis/dart_jts/precision/common_bits.dart';
part 'src/com/hydrologis/dart_jts/operation/cascaded_polygon_union.dart';
part 'src/com/hydrologis/dart_jts/operation/overlap_union.dart';
part 'src/com/hydrologis/dart_jts/operation/point_geometry_union.dart';
